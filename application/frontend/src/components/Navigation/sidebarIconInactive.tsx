...
const SidebarIconInactive = (props: iconProps) => {
    return(
        <li data-tip={props.tooltipText} className="tooltip tooltip-right pl-1.5">
            <div className="m-3 indicator">
                ...
                <Link href={props.destination} >
                    <a className="bg-white hover:bg-backgroundDark rounded-2xl grid w-11 h-11 place-items-center">
...
export default SidebarIconInactive;